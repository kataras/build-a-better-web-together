...
I was wondering if golang wasn't so fast on the web as I was reading, but, before let Golang and continue to develop with nodejs I told to my self '**Makis, don't lose your hope, give a last chance to the Golang. Try to build something totally alone without being affected from others code, learn the secrets of this language and make other frameworks to follow your steps!**' 
