...
// example: https://github.com/iris-contrib/examples/blob/4.0.0/letsencrypt/main.go
...
* [Listen using a custom fasthttp server](https://github.com/iris-contrib/examples/tree/4.0.0/custom_fasthttp_server)
* [Serve content using a custom router](https://github.com/iris-contrib/examples/tree/4.0.0/custom_fasthttp_router)
* [Listen using a custom net.Listener](https://github.com/iris-contrib/examples/tree/4.0.0/custom_net_listener)
* [Redirect all http://$HOST to https://$HOST using a custom net.Listener](https://github.com/iris-contrib/examples/tree/4.0.0/listentls)
* [Listen using automatic ssl](https://github.com/iris-contrib/examples/tree/4.0.0/letsencrypt)
