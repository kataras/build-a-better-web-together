...
//
// example: https://github.com/iris-contrib/examples/blob/5.0.0/letsencyrpt/main.go
...
//
// example: https://github.com/iris-contrib/examples/tree/5.0.0/multiserver_listening2
...
View all configuration fields and options by navigating to the [kataras/iris/configuration.go source file](https://github.com/kataras/iris/blob/5.0.0/configuration.go), to view the testing configuration move [here](https://github.com/kataras/iris/blob/5.0.0/httptest/httptest.go)