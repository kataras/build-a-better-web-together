...
* **Build'n support for html/template & flosch/pongo2**: Select the way you prefer to render your html files, switchable via one line configuration, [read more](render_templates.md)
