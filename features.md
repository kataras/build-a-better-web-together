...
* **Switch between template engines**: Select the way you prefer to render your html files, switchable via one line configuration, [read more](render_templates.md)
